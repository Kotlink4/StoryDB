...
public class RelationsController(StoryDbContext dbContext) : ControllerBase
{
    ...
    public async Task<ActionResult<RelationGraphDto>> GetRelationGraph(int projectId)
    {
        ...
        return Ok(new RelationGraphDto(nodes, edges));
    }
    ...
    public async Task<ActionResult<RelationGraphLayoutDto?>> GetDefaultLayout(int projectId)
    {
        ...
        return Ok(layout is null ? null : ToLayoutDto(layout));
    }
        ...
        RelationGraphLayoutRequest request)
    {
        ...
        {
            return BadRequest(invalidLayoutItemError);
        }
        ...
        {
            return BadRequest("Layout contains objects from another project or missing objects.");
        }
