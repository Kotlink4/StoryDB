  ...
  return (
    <PreviewDialog title={editingTimelineEventId === null ? ui.newEvent : ui.timelineEventEditor} onClose={onCancel}>
      <div className="sp-form">
        ...
        <label>
          {ui.firstName}
          <input value={draft.title} onChange={(event) => onDraftChange((currentDraft) => ({ ...currentDraft, title: event.target.value }))} />
        </label>
        <label>
        ...
        {isRangeEvent && (
          <>
            <label>
              {ui.end}
              <input value={draft.endLabel} onChange={(event) => onDraftChange((currentDraft) => ({ ...currentDraft, endLabel: event.target.value }))} />
            </label>
            <label>
              {ui.endPosition}
              <input
        ...
        <label>
          {ui.catalog}
          <input value={draft.category} onChange={(event) => onDraftChange((currentDraft) => ({ ...currentDraft, category: event.target.value }))} />
        </label>
        <label>
          {ui.color}
          <input
