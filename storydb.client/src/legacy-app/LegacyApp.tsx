...
const translations = {
  en: {
    ...
    projectSummary: 'A saved StoryDB project from the local database.',
    cover: 'Cover',
    coverDropzone: 'Drag and drop a cover image here',
    projectDetails: 'Details',
    projectGenre: 'Worldbuilding',
    ...
    changeTypeStructureAssignment: 'Structure assignment',
  ...
  ru: {
    ...
    projectSummary: 'Сохраненный проект StoryDB из локальной базы данных.',
    cover: 'Обложка',
    coverDropzone: 'Перетащи изображение обложки сюда',
    projectDetails: 'Детали',
    projectGenre: 'Миростроение',
    ...
    changeTypeStructureAssignment: 'Назначение структуры',
...
function StoryDbApp() {
  ...
  const timelineChangeTypeLabels: Record<TimelineChangeType, string> = {
    ...
    structureAssignment: t.changeTypeStructureAssignment,
